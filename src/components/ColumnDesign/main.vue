...
const defaultFunc = '({ data, index, request, toast, refresh, rowDataOperation }) => {\r\n    \r\n}'
...
export default {
  ...
  data() {
    return {
      __source_path: 'src/components/ColumnDesign/main.vue',
      currentTab: 'column',
  ...
  methods: {
    ...
    */
    ...
    editFunc(item) {
      ...
      this.$nextTick(() => {
        this.$refs.customBtn.init('pc', item.event, this.webType, this.columnOptions, item.event.func)
      })
    },
    updateScript(func) {
