<template>
  <div class="popupSelect-container" source="src/components/Generator/components/PopupSelect/index.vue">
    <div class="el-select" @click="openDialog">
      <el-input :placeholder="placeholder" v-model="innerValue" readonly :disabled="disabled" :validate-event="false"
