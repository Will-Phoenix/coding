<template>
  <el-dialog :close-on-click-modal="false" class="JNPF-dialog JNPF-dialog_center form-script-dialog"
    lock-scroll append-to-body v-bind="$attrs" width="70vw" :modal-append-to-body="false"
    v-on="$listeners" @open="onOpen" source="src/components/Generator/index/FormScript.vue">
