...
export default {
  ...
  watch: {
    activeName(val) {
      ...
      this.isAsync = false
      if (!val) return
      this.nodeId = this.userInfo.organizeId || '0'
      this.treeData = []
      this.treeData2 = []
      this.treeData3 = []
      this.getData()
  ...
  methods: {
    ...
    getData() {
      if (this.activeName === 'all') {
        ...
        this.loading = true
        this.treeData2 = []
        getOrganization({ keyword: this.pagination.keyword, organizeId: this.userInfo.organizeId || '0' }).then(res => {
    ...
    getList() {
      this.loading = true
      if (this.pagination.keyword) this.nodeId = this.userInfo.organizeId || '0'
