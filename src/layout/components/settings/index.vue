<template>
  <el-drawer :visible.sync="drawer" direction="rtl" :with-header="false"
    ...
    <el-divider v-if="define.enableSlideClassSet">{{$t('settings.lightOrDark')}}</el-divider>
    <ul v-if="define.enableSlideClassSet" class="nav_items">
    ...
    <el-divider v-if="define.enableThemeSet">{{$t('settings.theme')}}</el-divider>
    <div v-if="define.enableThemeSet" class="colorList">
