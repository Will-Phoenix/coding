  ...
  <div class="JNPF-common-layout">
    <div class="content" v-loading="loading">
        ...
        <div class="left">
          <el-card class="size1">
            ...
            <div style="margin-bottom: 24px">
              <el-tag v-if="detailData.paymentOrderUpload" effect="dark" size="middle" class="tag-success">已录入银行付款单</el-tag>
              ...
              <el-tag v-if="detailData.accountingStatus" effect="plain" size="middle" class="tag-plain">记账凭证号 {{ detailData.voucherYear }}年{{ detailData.voucherMonth }}月记{{ detailData.voucherNo }}号</el-tag>
            </div>
        ...
        <div class="right">
          <el-card class="size1">
            <div slot="header" class="row-flex" :style="{ margin: payCertificateList.length > 0 ? '-7px 0' : '' }">
              ...
              <div v-if="payCertificateList.length > 0" style="color: #00B4C4;font-weight: 500;line-height: 20px;">{{ payCertificateList.length }}条付款证明</div>
            </div>
      ...
      <div class="bottom-bar">
        ...
        <!--          批量下载原件-->
        <!--        </el-button>-->
        <div v-if="propertyJson && propertyJson.printShow && detailData.printNum" style="margin: 0 10px;">已打印（{{ detailData.printNum }}次）</div>
