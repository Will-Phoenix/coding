      ...
      <div class="main" v-loading="formLoading">
        <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="120px">
          <div class="JNPF-common-title mb-20">
            <h2 class="bold">账户信息
              <el-tooltip effect="dark" content="新用户初始密码默认是0000" placement="top">
                <a class="el-icon-warning-outline" />
              </el-tooltip>
            </h2>
          </div>
          <el-row :gutter="20" class="custom-row">
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="公务卡号" prop="bankCardNo">
                <el-input v-model="dataForm.bankCardNo" placeholder="公务卡号" maxlength="40" />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="银行卡号1" prop="selfBankCardNo1">
                <el-input v-model="dataForm.selfBankCardNo1" placeholder="银行卡号" maxlength="20" />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="开户行1" prop="selfBankCardAddress1">
                <el-input v-model="dataForm.selfBankCardAddress1" placeholder="开户行" maxlength="20" />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="银行卡号2" prop="selfBankCardNo2">
                <el-input v-model="dataForm.selfBankCardNo2" placeholder="银行卡号" maxlength="20" />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="开户行2" prop="selfBankCardAddress2">
                <el-input v-model="dataForm.selfBankCardAddress2" placeholder="开户行" maxlength="20" />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="直属主管" prop="managerId">
                <user-select v-model="dataForm.managerId" placeholder="选择直属主管" :parent-id="userInfo.companyId || '0'" />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="财会账号" prop="financialUserNo">
                <el-input v-model="dataForm.financialUserNo" placeholder="三方财会系统用户标识" maxlength="100" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="账号截止日期" prop="deadline">
                <el-date-picker
  ...
  data() {
    return {
      ...
      dataForm: {
        ...
        realName: '',
        bankCardNo: "", // 新增-公务卡号
        selfBankCardNo: "", // 新增-银行卡号
        selfBankCardNo1: "", // 新增-银行卡号1
        selfBankCardNo2: "", // 新增-银行卡开户行1
        selfBankCardAddress1: "", // 新增-银行卡号2
        selfBankCardAddress2: "", // 新增-银行卡开户行2
        organizeId: '',
        organizeIdTree: [],
        managerId: '',
        positionId: '',
      ...
      dataRule: {
        ...
        positionId: [
          { required: true, message: '请选择岗位', trigger: 'click' }
        ],
        mobilePhone: [
        ...
        bankCardNo: [
          { validator: this.validateCard('businessCard'), trigger: 'blur' }
        ],
        selfBankCardNo1: [
          { validator: this.validateCard('idCard'), trigger: 'blur' }
        ],
        selfBankCardNo2: [
          { validator: this.validateCard('idCard'), trigger: 'blur' }
        ]
      ...
      this.$nextTick(() => {
        ...
        if (this.dataForm.id) {
          getUserInfo(this.dataForm.id).then(res => {
            ...
            if (this.dataForm.selfBankCardNo) {
              const arr = JSON.parse(this.dataForm.selfBankCardNo);
              if (typeof arr === "object" && Array.isArray(arr)) {
                if (arr.length > 0) {
                  this.$set(this.dataForm, 'selfBankCardNo1', arr[0].cardNo)
                  this.$set(this.dataForm, 'selfBankCardAddress1', arr[0].address)
                }
                if (arr.length > 1) {
                  this.$set(this.dataForm, 'selfBankCardNo2', arr[1].cardNo)
                  this.$set(this.dataForm, 'selfBankCardAddress2', arr[1].address)
                }
              }
            }
    ...
    handleConfirm() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          if (this.dataForm.selfBankCardNo1 || this.dataForm.selfBankCardNo2) {
            const arr = []
            if (this.dataForm.selfBankCardNo1) {
              arr.push({
                cardNo: this.dataForm.selfBankCardNo1,
                address: this.dataForm.selfBankCardAddress1,
              })
            }
            if (this.dataForm.selfBankCardNo2) {
              arr.push({
                cardNo: this.dataForm.selfBankCardNo2,
                address: this.dataForm.selfBankCardAddress2,
              })
            }
            this.dataForm.selfBankCardNo = JSON.stringify(arr)
          }
