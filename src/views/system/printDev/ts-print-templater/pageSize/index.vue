    ...
    <el-form :model="form" :label-position="'top'">
      ...
      <el-form-item label="页边距" :label-width="formLabelWidth">
        <el-row :gutter="30">
          ...
          <el-col :span="9"><el-input-number style="width: 60px" v-model="form.mt" :min="0"
              :controls="false"></el-input-number>
            <span style="margin-left:10px">mm</span>
          </el-col>
          <el-col :span="1">下</el-col>
          <el-col :span="9"><el-input-number style="width: 60px" v-model="form.mb" :min="0"
              :controls="false"></el-input-number>
            <span style="margin-left:10px">mm</span>
          </el-col>
        </el-row>
        <el-row class="mt10" :gutter="30">
          ...
          <el-col :span="9"><el-input-number style="width: 60px" v-model="form.ml" :min="0"
              :controls="false"></el-input-number>
            <span style="margin-left:10px">mm</span>
          </el-col>
          <el-col :span="1">右</el-col>
          <el-col :span="9"><el-input-number style="width: 60px" v-model="form.mr" :min="0"
              :controls="false"></el-input-number>
            <span style="margin-left:10px">mm</span>
          </el-col>
        </el-row>
