<template>
  <el-dialog :visible.sync="visible" fullscreen lock-scroll class="JNPF-full-dialog"
    :show-close="false" :modal="false" append-to-body source="src/views/workFlow/flowEngine/Form.vue">
    <div class="JNPF-full-dialog-header" source="src/views/workFlow/flowEngine/Form.vue">
