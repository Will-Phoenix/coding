<template>
  <div class="JNPF-common-layout" source="src/views/workFlow/flowLaunch/index.vue">
    <div class="JNPF-common-layout-center">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <div class="JNPF-common-head">
          <!-- <topOpts @add="addFlow()" add-text="新建流程" /> -->
        ...
        <JNPF-table v-loading="listLoading" :data="list">
          ...
          <el-table-column prop="completion" label="流程进度" width="150">
            <template slot-scope="scope">
              ...
              <el-progress :percentage="scope.row.completion" v-else />
            </template>
          </el-table-column>
          <el-table-column label="操作" width="150" fixed="right">
            <template slot-scope="scope">
              <el-button
                ...
                :disabled="[1,2,4,5].indexOf(scope.row.status)>-1"
              >编辑
              </el-button>
              <el-button
                size="mini"
                ...
                :disabled="[1,2,3,5].indexOf(scope.row.status)>-1"
              >删除
              </el-button>
              <el-button
                size="mini"
