<template>
  <transition name="el-zoom-in-center" source="src/views/workFlow/formDesign/Preview.vue">
    <div class="JNPF-preview-main flow-form-main" source="src/views/workFlow/formDesign/Preview.vue">
