<template >
  <div class="flow-form" :style="{margin: '0 auto',width:formConf.fullScreenWidth}" source="src/views/workFlow/workFlowForm/dynamicForm/index.vue">
    <parser :form-conf="formConf" :form-operates="setting.formOperates" @submit="submitForm" :key="key" ref="dynamicForm" v-if="!loading" />
...
export default {
  ...
  data() {
    return {
      __source_path: 'src/views/workFlow/workFlowForm/dynamicForm/index.vue',
      setting: {},
      formData: {},
      loading: true,
      eventType: '',
