<template>
  <div class="flow-form">
    ...
    <bureauCashPaymentForm :visible.sync="formDialog.visible" :data="formDialog.data" @confirm="updateFormData()" />
  </div>
</template>
...
import bureauCashPaymentForm from "./components/bureauCashPaymentForm.vue";
import { FlowBeforeInfo } from "@/api/workFlow/FlowBefore";

export default {
  components: { FormOrder, bureauCashPaymentForm },
  mixins: [comMixin],
  data() {
    return {
      dataForm: {},
