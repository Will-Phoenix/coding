<template>
  <div class="flow-form">
    ...
    <bureauSporadicBillsExsForm :visible.sync="formDialog.visible" :data="formDialog.data" @confirm="updateFormData()" />
  </div>
</template>
...
import bureauSporadicBillsExsForm from "./components/bureauSporadicBillsExsForm.vue";
import { FlowBeforeInfo } from "@/api/workFlow/FlowBefore";

export default {
  components: { FormOrder, bureauSporadicBillsExsForm },
  mixins: [comMixin],
  data() {
    return {
      dataForm: {},
