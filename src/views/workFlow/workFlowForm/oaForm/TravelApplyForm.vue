<template>
  <div class="flow-form" source="src/views/workFlow/workFlowForm/oaForm/ccdTravelApply">
    <!-- <div class="com-title">
      <h1>{{ dataForm.name }}</h1>
    </div> -->
    ...
    <bureauTravelApplyForm :visible.sync="formDialog.visible" :data="formDialog.data" @confirm="updateFormData()" />
  </div>
</template>
...
import bureauTravelApplyForm from "./components/bureauTravelApplyForm";
import { FlowBeforeInfo } from "@/api/workFlow/FlowBefore";

export default {
  components: { FormOrder, bureauTravelApplyForm },
  mixins: [comMixin],
  data() {
    return {
      dataForm: {},
