<template>
  <div class="flow-form" source="src/views/workFlow/workFlowForm/oaForm/ccdTravelApply">
    ...
    <bureauTravelExsForm :visible.sync="formDialog.visible" :data="formDialog.data" @confirm="updateFormData()" />
  </div>
</template>
...
import bureauTravelExsForm from "./components/bureauTravelExsForm";
import { FlowBeforeInfo } from "@/api/workFlow/FlowBefore";

export default {
  components: { FormOrder, bureauTravelExsForm },
  mixins: [comMixin],
  data() {
    return {
      dataForm: {},
