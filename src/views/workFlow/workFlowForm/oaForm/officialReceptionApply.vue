<template>
  <div class="flow-form">
    ...
    <Form :visible.sync="formDialog.visible" :data="formDialog.data" @confirm="updateFormData()" />
  </div>
</template>
...
import Form from "./components/bureauOfficialReceptionApplyForm";
import { FlowBeforeInfo } from "@/api/workFlow/FlowBefore";

export default {
  components: { FormOrder, Form },
  mixins: [comMixin],
  data() {
    return {
      dataForm: {},
