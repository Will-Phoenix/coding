<template>
  <div class="flow-form" v-loading="loading" source="src/views/workFlow/workFlowForm/salesOrder/index.vue">
    <div class="com-title">
      <h1>销售订单</h1>
    ...
    <template v-if="judgeShow('entryList')">
      ...
      <el-table :data="dataForm.entryList" size='mini'>
        ...
        <el-table-column prop="qty" label="数量" v-if="judgeShow('entryList-qty')">
          <template slot="header" v-if="judgeRequired('entryList-qty')">
